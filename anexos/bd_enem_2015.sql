...
-- Thu 09 Nov 2017 04:28:36 PM -02
...
CREATE TABLE IF NOT EXISTS `bd_enem_2015`.`Escola` (
  ...
  INDEX `fk_Escola_Municipio1_idx` (`Municipio_IdMunic` ASC),
...
-- -----------------------------------------------------
-- Table `bd_enem_2015`.`AreaConhecimento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bd_enem_2015`.`AreaConhecimento` (
...
-- -----------------------------------------------------
-- Table `bd_enem_2015`.`CorProva`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bd_enem_2015`.`CorProva` (
  `idCorProva` INT NOT NULL,
  `Nome` VARCHAR(45) NULL,
  PRIMARY KEY (`idCorProva`));
...
CREATE TABLE IF NOT EXISTS `bd_enem_2015`.`TipoProva` (
  ...
  PRIMARY KEY (`CodTipo`),
  INDEX `fk_TipoProva_AreaConhecimento1_idx` (`AreaConhecimento_idAreaConhecimento` ASC),
  INDEX `fk_TipoProva_CorProva1_idx` (`CorProva_idCorProva` ASC),
  CONSTRAINT `fk_TipoProva_AreaConhecimento1`
    FOREIGN KEY (`AreaConhecimento_idAreaConhecimento`)
    REFERENCES `bd_enem_2015`.`AreaConhecimento` (`idAreaConhecimento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TipoProva_CorProva1`
    FOREIGN KEY (`CorProva_idCorProva`)
    REFERENCES `bd_enem_2015`.`CorProva` (`idCorProva`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `bd_enem_2015`.`Candidato_has_NecessidadeEspecial` (
  `Candidato_IdCandidato` INT NOT NULL,
  `NecessidadeEspecial_IdTipoNecess` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bd_enem_2015`.`CadernoProva` (
  ...
  CONSTRAINT `fk_CadernoProva_Prova1`
    FOREIGN KEY (`Prova_IdProva`)
    REFERENCES `bd_enem_2015`.`Prova` (`IdProva`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_CadernoProva_TipoProva1`
    FOREIGN KEY (`TipoProva_CodTipo`)
    REFERENCES `bd_enem_2015`.`TipoProva` (`CodTipo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
