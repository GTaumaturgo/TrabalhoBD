...
-- Thu 09 Nov 2017 12:22:50 AM -02
...
-- -----------------------------------------------------
-- Table `bd_enem_2015`.`GabaritoProva`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bd_enem_2015`.`GabaritoProva` (
  `VetorGab` VARCHAR(45) NOT NULL,
  `CodProva` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bd_enem_2015`.`Prova` (
  ...
  `Municipio_IdMunic` INT NOT NULL,
  `Candidato_IdCandidato` INT NOT NULL,
  `GabaritoProva_CodProva` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`IdProva`),
  ...
  INDEX `fk_Prova_GabaritoProva1_idx` (`GabaritoProva_CodProva` ASC),
  ...
  CONSTRAINT `fk_Prova_Candidato1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Prova_GabaritoProva1`
    FOREIGN KEY (`GabaritoProva_CodProva`)
    REFERENCES `bd_enem_2015`.`GabaritoProva` (`CodProva`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
